class TwoCriteriaController < ApplicationController
  ...
  private
    ...
    def two_criterium_params
      params.require(:two_criterium).permit(:C1lowervalue, :C1loweroperator, :C1uppervalue, :C1upperoperator, :C2lowervalue, :C2loweroperator, :C2uppervalue, :C2upperoperator)
    end
end
